...
const cards = [
    {
      title: <>Up to 90% <span className="text-[#E5CD7C]">Profit Split</span></>,
      icon: challenge,
      description: [
    ...
    {
      title: <>Fast <span className="text-[#04C5D2]">Bi-Weekly</span> Payouts</>,
      icon: objectives,
      description: [
    ...
    {
      title: <>Realistic Profit <span className="text-[#e5cd7c]">Objectives</span></>,
      icon: capital,
      description: [
    ...
    <div className="w-full mt-[9rem]">
        <div className="px-12 py-14 rounded-[2.2rem] overflow-hidden bg-[#1D1E21] relative">
            ...
            <div className="flex items-end justify-between mt-14">
                {/* CTA Button */}
                <button 
                    className="mt-8 relative z-10 shadow-yellow-glow group transition-all border-[1.3px] border-[#E5CD7C] h-[4.3rem] px-16 flex items-center justify-center gap-5 rounded-full "
                >
            ...
            {cards.map((item, id) => (
                ...
                >
                    <Image
                        ...
                        alt=""
                    />
                    <div style={{ background: item.color }} className={`w-full h-[1.5px] min-h-[1.5px] relative`}>
        ...
        <div className="w-full flex flex-col items-center justify-start">
            ...
            <p className="max-w-[66rem] text-center text-[#8F8F8F] font-neuehaas text-[1.36rem] ">
                <span className="text-[#0EC0C8]">Guardeer</span>{" "}
                Funding knows a solid trading environment is key to success. That's why we offer two powerful platforms for traders who mean business.
            </p>
            <p className="pt-3 font-neuehaas text-[#d2d2d2] text-[1.36rem]">
            Our selected trading platforms give you a high-performance trading experience with:
            </p>
        </div>
    </div>
  );
