  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center gap-3">
        ...
        <button className="bg-blue-yellow-gradient hover:bg-yellow-blue-gradient transition-all h-12 w-40 p-[2px] font-ttc text-white flex items-center justify-center text-lg font-semibold rounded-full">
