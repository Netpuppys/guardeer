...
const CardsSectionsMobile = () => {
  ...
  return (
    <div className='w-full md:hidden '>
        ...
        <div className="z-10 animate-slide-left w-full overflow-hidden bg-black-right-gradient hidden items-center mt-10">
            <Swiper
                ref={swiperRef}
                autoplay={{
                    delay: 0,
            ...
            >
                {card.map((card, index) => (
                <SwiperSlide key={index} className="min-w-[75vw] max-w-[75vw] w-[75vw] px-6 h-fit">
                    <div
