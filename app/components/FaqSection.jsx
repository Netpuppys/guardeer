...
const data = [
    {
        ...
        answer: "Guardeer Funding is a proprietary trading firm based in Hong Kong, offering simplified evaluation challenges for traders of all levels to help them succeed."
    },
    {
                ...
                >
                    ...
                    >
                        <div className='w-full h-full rounded-full flex items-center justify-between px-10 bg-black'>
                            ...
                            <p className={`transition-all duration-500 text-[2rem] text-[#8F8F8F] group-hover:text-white
                    ...
                    `}>
                        <p className={`transition-all px-10 pt-8 font-ttc text-[1.4rem] font-medium text-[#C5C5C5]`}>
                            {item.answer}
                        </p>
                    </div>
                </div>
